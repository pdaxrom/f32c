...
-- Module  Version: 5.7
--/opt/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n clkgen -lang vhdl -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 384 -fclkop_tol 0.0 -fclkos 384 -fclkos_tol 0.0 -fclkos2 96 -fclkos2_tol 0.0 -fclkos3 48 -fclkos3_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phases3 0 -phase_cntl STATIC -fb_mode 1 

-- Mon Apr 30 22:38:18 2018
...
architecture Structure of clkgen is
    ...
    attribute FREQUENCY_PIN_CLKOS3 of PLLInst_0 : label is "48.000000";
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "96.000000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "384.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "384.000000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "12.000000";
    attribute ICP_CURRENT of PLLInst_0 : label is "7";
    attribute LPF_RESISTOR of PLLInst_0 : label is "40";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_USE_WB=> "DISABLED", CLKOS3_FPHASE=>  0, CLKOS3_CPHASE=>  7, 
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  3, CLKOS_FPHASE=>  0, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  8, CLKOS2_DIV=>  4, 
        CLKOS_DIV=>  1, CLKOP_DIV=>  1, CLKFB_DIV=>  32, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
